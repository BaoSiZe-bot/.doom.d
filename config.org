...
(setq doom-font (font-spec :family "VictorMono Nerd Font" :size 17 :weight 'Regular)
      doom-symbol-font (font-spec :family "LXGW WenKai Mono GB" :size 17 :weight 'Regular)
      doom-variable-pitch-font (font-spec :family "LXGW WenKai Mono GB" :size 17 :weight 'Regular)
